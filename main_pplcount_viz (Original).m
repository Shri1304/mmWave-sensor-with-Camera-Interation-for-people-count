...
function close_main()
 ...
 function RealTime(fHist)        
        if  myResetBaseline 
            myRealTimeBaseline = tic;  
            mySimulationTimeBaseline = fHist.CurrentTime;  
            ...
            differenceInSeconds = ((fHist.CurrentTime - mySimulationTimeBaseline) / mySimTimePerRealTime) - elapsedRealTime;
